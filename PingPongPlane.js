import {Curtains, Plane, Vec2, PingPongPlane, ShaderPass} from 'curtainsjs'
import flowMapshaderFS from './shaders/flowMapshaderFS.glsl';
import flowMapshaderVS from './shaders/flowMapshaderVS.glsl';
...
const renderFs = `
    ...
    // post pro
    const renderPass = new ShaderPass(curtains, params_two);
